...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, modality, base_width=32, num_classes=1000, pool='avgpool', zero_init_residual=False,
...
def _resnet(arch, block, layers, modality, progress, base_width, **kwargs):
    model = ResNet(block, layers, modality, base_width, **kwargs)
    return model


def resnet18(modality, base_width=64, progress=True, **kwargs):
    return _resnet('resnet18', BasicBlock, [2, 2, 2, 2], modality, progress, base_width, **kwargs)

...
DATASET_URL = r'/data/input-ai/datasets/VGGSound/vggsound.csv'
    ...
    with open(subset_path, 'r') as f:
        ...
        try:
            for row_idx, row in enumerate(subset_data):
                ...
                if row[0][0] == '#':
                    continue
                ytid, ts_start, ts_end = row[0], float(row[1]), float(row[1]) + 10
...
# python download_vgg_sound.py --data_dir /data/input-ai/datasets/VGGSound
